<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="applicationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="所在系部" align="center" prop="deptName" />
...
<script>
import { listApplication, getApplication, delApplication, addApplication, updateApplication,getDeptName,getType } from "@/api/application/application";
